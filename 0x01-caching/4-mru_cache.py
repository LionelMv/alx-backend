#!/usr/bin/env python3
"""
This module defines a caching class, `MRUCache`, that is derived
from the `BaseCaching` class. It provides MRU caching functionality
...
class MRUCache(BaseCaching):
    ...
    def put(self, key, item):
        ...
        Delete items using MRU if the number of dictionary items
    ...
    def get(self, key):
        ...
        Assist in getting the MRU key in the list.
        """
        if key:
